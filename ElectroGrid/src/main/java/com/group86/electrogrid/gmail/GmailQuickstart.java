package com.group86.electrogrid.gmail;


/*

586021912292-0p9vpgih7dldqe0h1pr6qne81aksicrb.apps.googleusercontent.com
Your Client ID
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
Your Client Secret
 */
/**
...
//			.asList(GmailScopes.GMAIL_LABELS);
	...
	public String sendTestMail(String toEmail,String subject,String message) {
		try{
			Gmail service = getGmailService();
			MimeMessage mm = createEmail(toEmail,"vithutheva98@gmail.com", subject, message);
			sendMessage(service, mm);
			return "Success";
		}catch (Exception e) {
	...
	public static Credential authorize() throws Exception {
		...
		InputStream in = GmailQuickstart.class
				.getResourceAsStream("/client_secret_vithusha.json");
	...
	public static Gmail getGmailService() throws Exception {
		...
		return new Gmail.Builder(HTTP_TRANSPORT, JSON_FACTORY, credential)
				.setApplicationName("electrogrid").build();
	}
	...
	public static void sendMessage(Gmail service,
		...
		//List<Users> users = (List<Users>) service.users();
